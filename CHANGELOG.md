...
- `from_huggingface` now resolves a repeated merge rule the way the HuggingFace
  `tokenizers` library does: the last occurrence sets its priority.
...
[Unreleased]: https://github.com/HFooladi/rustmolbpe/compare/v0.5.0...HEAD
[0.5.0]: https://github.com/HFooladi/rustmolbpe/compare/v0.4.0...v0.5.0
[0.4.0]: https://github.com/HFooladi/rustmolbpe/compare/v0.3.0...v0.4.0
